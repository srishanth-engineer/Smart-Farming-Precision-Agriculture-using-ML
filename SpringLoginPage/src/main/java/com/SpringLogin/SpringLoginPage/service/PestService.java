...
import com.SpringLogin.SpringLoginPage.repository.PestPred;
...
public class PestService {
    ...
    private final String FASTAPI_URL = "http://127.0.0.1:8000/predict-pest";

    @Autowired
    private PestPred pestRepo;

    public String predictPest(MultipartFile file) {
        ...
        try {
            ...
            PestPredictor pestPred = new PestPredictor(file.getOriginalFilename(), file.getContentType(), fileBytes);
            pestRepo.save(pestPred);
